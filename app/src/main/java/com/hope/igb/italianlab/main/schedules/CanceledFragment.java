...
public class CanceledFragment extends Fragment implements MyFirebaseBuilderImpl.ReservingCommandListener {
    private RecyclerView recyclerView;
    private final MyFirebaseBuilderImpl firebaseBuilder;


    public CanceledFragment(MyFirebaseBuilderImpl firebaseBuilder) {
    ...
    private void bindView(){
        ...
        firebaseBuilder.fetchReservations("Canceled");
    }
    ...
    public void onReservationsFetched(ArrayList<Reservation> reservations) {
        CanceledRecyclerAdapter adapter = new CanceledRecyclerAdapter(getContext(), reservations);
